...
export default function MonthlyRacePage() {
  ...
  const renderStatsBreakdown = (stats: MonthlyStats | LeaderboardEntry) => (
    <div className="space-y-4">
      {[
        { icon: Video, label: "Video đã xem", value: stats.videosWatched, xp: stats.videosWatched * 5, color: "#7c3aed" },
      ...
      {stats.watchMinutes > 0 && (
        <div className="pt-3 mt-3" style={{ borderTop: "1px solid var(--border)" }}>
          <div className="flex items-center justify-between text-sm">
            <span className="flex items-center gap-2 font-medium" style={{ color: "var(--foreground-muted)" }}>
          ...
          <div className="card-base max-w-md w-full animate-scale-in" onClick={e => e.stopPropagation()}>
            ...
            <div className="text-center mb-6">
              <div className="w-20 h-20 rounded-full mx-auto mb-3 flex items-center justify-center text-3xl font-bold"
                   style={{ background: "rgba(124,58,237,0.1)", border: "2px solid rgba(124,58,237,0.3)", color: "#7c3aed" }}>
      ...
      <div className="pt-24 pb-24 page-enter">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg max-w-2xl mx-auto" style={{ color: "var(--foreground-muted)" }}>
          ...
          <div className="flex items-center justify-center gap-6 mb-10">
            ...
            <div className="text-center min-w-[220px]">
              ...
              {isCurrentMonth && (
                <p className="text-sm mt-1 font-medium" style={{ color: "var(--foreground-muted)" }}>
          ...
          {isCurrentMonth && (
            <div className="max-w-xl mx-auto mb-10">
              <div className="flex justify-between text-xs font-semibold mb-2" style={{ color: "var(--foreground-muted)" }}>
            ...
            <div className="space-y-6">
              ...
              <div className="card-base relative overflow-hidden" style={{ border: "1px solid rgba(124,58,237,0.3)" }}>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm font-medium mt-2" style={{ color: "var(--foreground-muted)" }}>XP tháng này</p>
                </div>

                {myRank > 0 && (
                  <div className="text-center p-4 rounded-xl mb-6" style={{ background: "rgba(124,58,237,0.08)" }}>
                    <p className="text-sm font-medium mb-1" style={{ color: "var(--foreground-muted)" }}>Xếp hạng hiện tại</p>
                    <p className="text-3xl font-extrabold" style={{ color: myRank <= 3 ? RANK_STYLES[myRank - 1]?.color : "#7c3aed" }}>
                ...
                <div className="space-y-2">
                  <p className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: "var(--foreground-muted)" }}>Phần thưởng cuối tháng</p>
                  {[
                ...
                <div className="space-y-2 text-sm font-medium">
                  {[
                    ...
                    <div key={r.act} className="flex justify-between py-1.5 px-3 rounded-lg" style={{ background: "var(--muted)" }}>
                      <span style={{ color: "var(--foreground-muted)" }}>{r.act}</span>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="card-base">
                <h3 className="text-xl font-bold mb-8 flex items-center gap-2">
                  ...
                  <span className="text-sm px-3 py-1 rounded-full ml-auto font-medium" style={{ background: "var(--muted)", color: "var(--foreground-muted)" }}>
                ...
                {leaderboard.length === 0 ? (
                  <div className="text-center py-20">
                    <Trophy className="w-16 h-16 mx-auto mb-4 opacity-30" style={{ color: "var(--foreground-muted)" }} />
                          ...
                          return (
                            <button key={i} onClick={() => setSelectedUser(entry)} 
                              ...
                              <p className="text-sm font-bold text-center truncate w-full mb-1">
                                {entry.name} {isMe && <span style={{ color: "#a78bfa" }}>(bạn)</span>}
                              </p>
                        ...
                        <button key={entry.userId}
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-bold text-base truncate">
                              {entry.name}
                              {isMe && <span className="text-sm ml-2 font-semibold" style={{ color: "#a78bfa" }}>(bạn)</span>}
                            </p>
                          ...
                          {/* XP */}
                          <div className="text-right flex-shrink-0">
                            <p className="text-2xl font-extrabold" style={{ color: isTop3 ? RANK_STYLES[i]?.color : "#7c3aed" }}>
                              {entry.xp}
                            </p>
                            <p className="text-xs font-bold" style={{ color: "var(--foreground-muted)" }}>XP</p>
                          </div>
                        </button>
                      );
                    })}
                          ...
                          {h.winners.map(w => {
                            ...
                            return (
                              <div key={w.rank} className="flex items-center gap-4 text-base">
                                ...
                                <span className="text-sm font-extrabold" style={{ color: "var(--foreground-muted)" }}>{w.xp} XP</span>
